...
export const TIPS: Record<DimensionInternal, Tip[]> = {
  ...
  douleurs: [
    ...
    { id: "d8", icon: "🌡️", text: "La chaleur (bouillotte) soulage les tensions musculaires. Le froid calme les douleurs aiguës." },
  ...
  nutrition: [
    ...
    { id: "n6", icon: "🥜", text: "5 noix le matin = apport en oméga-3 qui réduit l'inflammation et protège tes muscles." },
    ...
    { id: "n9", icon: "🐟", text: "Les oméga-3 (poisson gras, noix, graines de lin) réduisent l'inflammation globale — 2 à 3 portions par semaine suffisent." },
...
export const PRODUCTS: Record<string, Product> = {
  ...
  semelles_ortho: {
    ...
    reason: "Amorti et soutien du pied — indispensable pour les postes debout prolongés",
